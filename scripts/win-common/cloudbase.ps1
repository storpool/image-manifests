...
$client.DownloadFile("https://github.com/cloudbase/cloudbase-init/releases/download/1.1.5/CloudbaseInitSetup_1_1_5_x64.msi", "C:\Windows\Temp\CloudbaseInitSetup_Stable_x64.msi" )
